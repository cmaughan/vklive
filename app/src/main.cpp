...
namespace vulkan
{
extern std::shared_ptr<IDevice> create_vulkan_device(SDL_Window* pWindow, bool viewports = false);
}
...
int main(int argc, char** argv)
{
    ...
    // Get the settings
    auto settings_path = file_init_settings("VkLive", runtree_find_path("settings.toml"));
    ...
    // Main device 
    g_pDevice = vulkan::create_vulkan_device(init_sdl_window(), appConfig.viewports);
